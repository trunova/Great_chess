...
public class Bishop extends Piece { // слон
    ...
    public Bishop(Alliance pieceAlliance, int x, int y) {
        super(pieceAlliance, x, y);
    }

    public Bishop(List<Integer[]> canGoFromThis, List<Integer[]> canAttackThis, int x, int y, Alliance pieceAlliance) {
